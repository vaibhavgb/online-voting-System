...
<%
		...
		data.executeQuery("SELECT cname,cvote FROM cndt WHERE casbly='" + "Maval" + "' ");
	
 		JFreeChart chart = ChartFactory.createPieChart("Maval CONSTITUENCIES",data, true, true,false);

 		try
		{
 			final ChartRenderingInfo info = new ChartRenderingInfo(new StandardEntityCollection());
  			final File file1 = new File("D:\\SERVER\\apache-tomcat-8.0.0-RC10\\webapps\\OV\\img\\piechartM.png");
...
<table width="900" style="margin-top:30" cellspacing="5">
	<tr>
		<td colspan="3" align="right"><h3><u>VOTTING &nbsp;RESULT&nbsp; FOR&nbsp; MAVAL &nbsp;CONSTITUENCIES</u></h3></td>
	</tr>
    <tr>
 ...
 <td width="600" rowspan="4"> <img src="img/piechartM.png" width="600" height="400" 
 ...
 <tr>
   <td bgcolor="#CC99FF" align="center" class="nv"><a href="vtrshirur.jsp"> SHIRUR</a></td>
