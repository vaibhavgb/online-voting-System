...
<%
		...
		data.executeQuery("SELECT cname,cvote FROM cndt WHERE casbly='" + "Pune" + "' ");
	
 		JFreeChart chart = ChartFactory.createPieChart("PUNE CONSTITUENCIES",data, true, true,false);

 		try
		{
 			final ChartRenderingInfo info = new ChartRenderingInfo(new StandardEntityCollection());
  			final File file1 = new File("F:\\SERVER\\apache-tomcat-8.0.0-RC10\\webapps\\OV\\img\\piechartP.png");
...
<table width="900" style="margin-top:30" cellspacing="5">
	<tr>
		<td colspan="3" align="right"><h3><u>VOTTING &nbsp;RESULT&nbsp; FOR&nbsp; PUNE &nbsp;CONSTITUENCIES</u></h3></td>
	</tr>
    <tr>
 ...
 <tr>
   <td width="171" class="nv" align="center" bgcolor="#CC99FF"><a href="vtrshirur.jsp"> SHIRUR</a></td>
   <td width="113" height="52" align="center">&nbsp;</td>
 <td width="600" rowspan="4"> <img src="img/piechartP.png" width="600" height="400" 
