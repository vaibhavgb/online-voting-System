...
<%
		...
		data.executeQuery("SELECT cname,cvote FROM cndt WHERE casbly='" + "Baramati" + "' ");
	
 		JFreeChart chart = ChartFactory.createPieChart("BARAMATI CONSTITUENCIES",data, true, true,false);

 		try
		{
 			final ChartRenderingInfo info = new ChartRenderingInfo(new StandardEntityCollection());
  			final File file1 = new File("D:\\SERVER\\apache-tomcat-8.0.0-RC10\\webapps\\OV\\img\\piechartB.png");
...
<table width="900" style="margin-top:30" cellspacing="5">
	<tr>
		<td colspan="3" align="right"><h3><u>VOTTING &nbsp;RESULT&nbsp; FOR&nbsp; BARAMATI &nbsp;CONSTITUENCIES</u></h3></td>
	</tr>
    <tr>
 ...
 <td width="600" rowspan="4"> <img src="img/piechartB.png" width="600" height="400" 
   border="0" usemap="#chart">
</td>
 </tr>
 <tr>
   <td bgcolor="#CCCCFF" align="center" class="nv"><a href="vtrshirur.jsp"> SHIRUR</a></td>
