...
<form action="adcdt_bak.jsp" method="post">
<table width="1137" height="267" border="0" cellpadding="2" cellspacing="5" style="margin-top:120px; margin-left:50px">
  <tr>
    ...
    <td width="663" class="nv" align="center">NAME OF CANDIDATE :  
  ...
  <tr>
    ...
    <td align="center" class="nv">PARLIAMENT CONSTITUENCY :  
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <select name="ihipr" class="sl" id="ihipr"  onchange="togle()">
   ...
   <tr>
    <td height="90">&nbsp;</td>
      <td style="background-color:#C0C0C0" width="100" align="center">SELECT PARTY NAME :  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      <select name="iparty" class="sl">
  ...
  <tr>
    ...
    <td align="center" class="nv">
        <input style="background-color:#009900" type="submit" value="INSERT">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
